...
$('#BtnCV').click(function(){
   $('#DownloadCV').attr("href", "images/Arshad_Resume");
});
...
$('.facebook').click(function(){
   ...
   window.location.href = "https://www.facebook.com/arshad.miyawala";       
...
$('.instagram').click(function(){
   ...
   setTimeout($.unblockUI, 2000);
   window.location.href = "http://instagram.com/B3ing_arshad";       
...
$('.whatsapp').click(function(){
   ...
   setTimeout($.unblockUI, 2000);
   window.location.href = "https://wa.me/+919925859611";        
})

/* START TYPEIT */

new TypeIt("#typename", {
  strings: "Arshad Miyawala",
  speed: 100,
//   loop: true,
}).go();
